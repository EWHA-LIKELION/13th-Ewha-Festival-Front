...
import BoothHeader from '@/pages/DetailPage/Show/components/BoothHeader';
import BoothInfo from '@/pages/DetailPage/Show/components/BoothInfo.jsx';
import BoothButton from '@/pages/DetailPage/Show/components/BoothButton.jsx';
import BoothMeta from '@/pages/DetailPage/Show/components/BoothMeta.jsx';
...
const ShowDetail = () => {
  const booth_id = 2; // ✅ 부스 목록 개발 끝나면 변경해주기
